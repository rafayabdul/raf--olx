                            ...
                            <div className="col-md-9">
                                <div className="catmain_content">
                                    <div className="heading">
                                        <h2>8923 Home Accessories for sale online in Dubai, UAE· 8923 ads</h2>
                                        <p>Get the latest Home Accessories deals at cheap prices.</p>
                                    </div>
                                    <div className="brand_box">
                                        <div className="breadcrumbs">
                                            <p>Browse results in: <a href="#">Dubai</a>  <a href="citiyana-motorcycles-category.html"> Furniture Home and garden</a>Accessories </p>
                                        </div>
                                        <div className="brandsAmount">
                                            <div className="row">
                                                ...
                                                <div className="col-md-3 col-sm-4">    
                                                    <div className="brandtag">
                                                        <a href="#">
                                                            <p>Bath Accessories ‬  <span>(1400)</span></p>
                                                        </a>
                                                    </div>
                                                </div> 
                                                <div className="col-md-3 col-sm-4">    
                                                ...
                                                <div className="col-md-3 col-sm-4">    
                                                    <div className="brandtag">
                                                        <a href="#">
                                                            <p>Kitchen & Dining <span>(1400)</span></p>
                                                        </a>
                                                    </div>
                                                </div> 
                                                <div className="col-md-3 col-sm-4">    
                                                    <div className="brandtag">
                                                        <a href="#">
                                                            <p>Bedding & Bed Accessories ‬ <span>(1400)</span></p>
                                                        </a>
                                                    </div>
                                                </div> 
                                                <div className="col-md-3 col-sm-4">    
                                                    <div className="brandtag">
                                                        <a href="#">
                                                            <p>Housekeeping ‬ <span>(634)</span></p>
                                                        </a>
                                                    </div>
                                                </div>
                                    ...
                                    <div className="cateList Box">
                                        <div className="image">
                                            <a href="#">
                                                <img src="assets/images/accessories/img2.webp" alt="" className="" />
                                            </a>
                                        </div>
                                        <div className="catDetail">
                                            ...
                                            <div className="breadcrum">
                                                <ul>
                                                    ...
                                                    <li><a href="#">FourWinns 175 hours only used like ... S-className</a></li>
                                                </ul>
                                            </div>
                                            <div className="date">
                                                <p>25 June 2020</p>
                                    ...
                                    <div className="cateList Box">
                                        <div className="image">
                                            <a href="#">
                                            <img src="assets/images/accessories/img3.webp" alt="" className="" />
                                            </a>
                                        </div>
                                        <div className="catDetail">
                                            <div className="heartFavour">
                                    ...
                                    <div className="cateList Box">
                                        <div className="image">
                                            <a href="#">
                                            <img src="assets/images/accessories/img4.webp" alt="" className="" />
                                            </a>
                                        </div>
                                        <div className="catDetail">
                                            <div className="heartFavour">
                                            ...
                                            <div className="breadcrum">
                                                <ul>
                                                    ...
                                                    <li><a href="#">2019 MONSTER 821 S-className</a></li>
                                                </ul>
                                            </div>
                                            <div className="date">
                                                <p>20 June 2020</p>
                                    ...
                                    <div className="cateList Box">
                                        <div className="image">
                                            <a href="#">
                                                <img src="assets/images/accessories/img5.webp" alt="" className="" />
                                            </a>
                                        </div>
                                        <div className="catDetail">
                                            <div className="heartFavour">
                                            ...
                                            <div className="breadcrum">
                                                <ul>
                                                    ...
                                                    <li><a href="#">Ducati Monster 821 S-className</a></li>
                                                </ul>
                                            </div>
                                            <div className="date">
                                                <p>2 July 2020</p>
                                        ...
                                        <div className="catDetail">
                                            ...
                                            <div className="breadcrum">
                                                <ul>
                                                    ...
                                                    <li><a href="#">Ducati 1199 S panigale S-className</a></li>
                                                </ul>
                                            </div>
                                            <div className="date">
                                                <p>19 June 2020</p>
...
export default CategoryMobAccesories;
